													...
													<tr>
														<td style="overflow-wrap:break-word;word-break:break-word;padding:35px 10px 10px;font-family:'Lato',sans-serif;" align="left">
															<table width="100%" cellpadding="0" cellspacing="0" border="0">
																<tr>
																	<td style="padding-right: 0px;padding-left: 0px;" align="center"> <img align="center" border="0" src="https://www.pikpng.com/pngl/m/108-1083508_facebook-notification-icon-vector-wwwimgkidcom-the-logo-linkedin.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 10%;max-width: 58px;" width="58" /> </td>
																</tr>
															</table>
														</td>
													</tr>
													...
													<tr>
														<td style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 30px;font-family:'Lato',sans-serif;" align="left">
															<div style="line-height: 140%; text-align: left; word-wrap: break-word;">
																<p style="line-height: 140%; text-align: center; font-size: 14px;"><span style="color: #ffffff;"><span style="font-size: 28px; line-height: 39.2px;">Change Of Odds Notification</span></span>
																</p>
															</div>
														</td>
													</tr>
													...
													<tr>
														<td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;" align="left">
															<div style="line-height: 140%; text-align: left; word-wrap: break-word;">
																...
																<p style="font-size: 14px; line-height: 140%;">Odds are changed so, I hereby notify you about that. Details are Given Below:</p>
																<br>
																<p style="font-size: 14px; line-height: 140%;">
																	<table class="blueTable">
																		...
																		<tbody>
																			<tr>
																				<td>Odds Type</td>
																				<td style="background-color: #D0E4F5;">{team1}</td>
																				<td style="background-color: #D0E4F5;">{team2}</td>
																			</tr>
																			<tr>
																				<td style="background-color: #D0E4F5;">Current Odds</td>
																				<td>{curr_team1}</td>
																				<td>{curr_team2}</td>
																			</tr>
																			<tr>
																				<td style="background-color: #D0E4F5;">Previous Odds</td>
																				<td><span>{old_team1}</span></td>
																				<td><span>{old_team2}</span></td>
																			</tr>
																		</tbody>
																	</table>
																</p>
												...
												<tbody>
													<tr>
														<td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Lato',sans-serif;" align="left">
															<div style="line-height: 140%; text-align: left; word-wrap: break-word;">
																<p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="font-size: 16px; line-height: 22.4px; color: #ecf0f1;">Sending you this email from 3838.com Crawler.</span></p>
															</div>
														</td>
													</tr>
												</tbody>
