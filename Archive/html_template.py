...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="https://www.pikpng.com/pngl/m/108-1083508_facebook-notification-icon-vector-wwwimgkidcom-the-logo-linkedin.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 10%;max-width: 58px;" width="58"/>
    </td>
  </tr>
</table>
...
<table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="line-height: 140%; text-align: center; font-size: 14px;"><span style="color: #ffffff;"><span style="font-size: 28px; line-height: 39.2px;">Change Of Odds Notification</span></span></p>
  </div>
...
<p style="font-size: 14px; line-height: 140%;">Odds here:</p>
  </div>
